//1. Create Java classes having suitable attributes for Library management system.Use OOPs concepts
...
class Lib extends Library implements LibraryProp {
    ...
    public Lib(String rn, String rm, String bn) {
        Member_name = rn;
        Member_mobile = rm;
        book_name = bn;
    }
...
class Question1 {
    public static void main(String[] args) {
        Lib l = new Lib("xyz", "11111111111", "Book1");
        Lib l2 = new Lib("abc", "2222222222", "Book2");
        l.issueBook();
        l.returnBook();
        l.getMemberDetails();
        l2.issueBook();
